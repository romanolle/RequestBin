...
exec java -Djava.security.egd=file:/dev/./urandom -jar -Dfile.encoding=UTF-8 /opt/request-bin/request-bin-1.0.0.DEV.jar --logging.level.com.unitron.ucloud=DEBUG
